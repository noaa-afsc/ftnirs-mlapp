...
#dirty workaround, but likely not bad from a performance standpoint
...
app_header = html.Div([
        ...
        #html.Div(id="secondline", children = [
                ...
                html.Div(id="current-jobs",children="Concurrent tensorflow jobs:", style={"display": "inline-block", 'textAlign': 'right'}),
                # "float": "right"
